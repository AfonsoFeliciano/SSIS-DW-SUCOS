...
GO
PRINT N'Rename refactoring operation with key 71eb7fa0-d20b-425a-8107-5a59e9f4a8a0 is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key d89e42a8-f576-4378-9140-5451881bc120 is skipped, element [dbo].[Fato_001].[Quantidade] (SqlSimpleColumn) will not be renamed to Quantidade_Vendida';
