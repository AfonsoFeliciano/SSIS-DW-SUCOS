...
GO
PRINT N'Rename refactoring operation with key b3b65159-e805-4c2e-a433-438416b74d53 is skipped, element [dbo].[Dim_Tempo].[Id] (SqlSimpleColumn) will not be renamed to Cod_Dia';


GO
PRINT N'Rename refactoring operation with key 55acda77-8a7a-4dc1-b730-763b05207925 is skipped, element [dbo].[Dim_Tempo].[E_Dia_Semana] (SqlSimpleColumn) will not be renamed to Tipo_Dia';
